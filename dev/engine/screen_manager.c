...
#include "..\screen\bonus_screen.h"
#include "..\screen\replay_screen.h"
#include "..\screen\reset_screen.h"
...
void engine_screen_manager_init(unsigned char open_screen_type)
{
	...
	load_method[ screen_type_bonus ] = screen_bonus_screen_load;
	load_method[ screen_type_replay ] = screen_replay_screen_load;
	...
	update_method[ screen_type_bonus ] = screen_bonus_screen_update;
	update_method[ screen_type_replay ] = screen_replay_screen_update;
